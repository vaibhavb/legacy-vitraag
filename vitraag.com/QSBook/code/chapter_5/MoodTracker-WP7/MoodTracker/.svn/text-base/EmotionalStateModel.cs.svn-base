...
namespace MoodTracker
{
    ...
    /// TODO: Test parsing thoroughly there are cases where the data is not handled properly.
    /// </summary>
    [DataContract(Name="emotionalstate")]
        ...
        private string thingXml =
            @"<thing>
                ...
                <data-xml>
                  ...
                  <common>
                    <source>vMudi - Mood Tracker for Windows Phone</source>
                    <note>{10}</note>
                  </common>
                </data-xml>
            </thing>";
