...
#ifndef lint
static char rcsid[] DD_UNUSED = "$Id: cuddZddCount.c,v 1.1.1.1 2003/04/24 23:35:11 ashwini Exp $";
#endif
...
/**Function********************************************************************
  ...
  returned as a double. If the procedure runs out of memory, it returns
  CUDD_OUT_OF_MEM. This procedure is used in Cudd_zddCountMinterm.]
