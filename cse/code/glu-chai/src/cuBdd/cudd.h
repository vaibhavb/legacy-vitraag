/**CHeaderFile*****************************************************************
  ...
  Revision    [$Id: cudd.h,v 1.2 2003/04/25 00:48:19 ashwini Exp $]
...
/**Macro***********************************************************************
  ...
  (CUDD_MAXINDEX). The pointer passed to Cudd_IsConstant may be either
...
******************************************************************************/
#define Cudd_IsConstant(node) ((Cudd_Regular(node))->index == CUDD_MAXINDEX)
...
/*ashwini add*/
EXTERN int Cudd_bddPickOneCubeRandom ARGS((DdManager *ddm, DdNode *node, char *string));
EXTERN DdNode * Cudd_bddPickOneMintermRandom ARGS((DdManager *dd, DdNode *f, DdNode **vars, int n));
/*ashwini add end */
